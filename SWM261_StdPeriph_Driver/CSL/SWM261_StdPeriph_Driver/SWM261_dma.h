#ifndef __SWM261_DMA_H__
#define __SWM261_DMA_H__
...
#define DMA_CH0_UART5RX		(2 | DMA_HS_SRC | DMA_DIR_RX)
...
#define DMA_CH2_SPI1RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH2_ADC0		(2 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH2_UART0RX		(3 | DMA_HS_SRC | DMA_DIR_RX)

#define DMA_CH3_UART2RX		(0 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH3_SPI0RX		(1 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH3_UART4RX		(2 | DMA_HS_SRC | DMA_DIR_RX)
#define DMA_CH3_UART1RX		(3 | DMA_HS_SRC | DMA_DIR_RX)
...
#define DMA_CH0_MPUTX		(3 | DMA_HS_DST | DMA_DIR_RX)
...
#define DMA_CH1_UART5TX		(3 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH2_UART2TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH2_SPI0TX		(1 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH2_UART1TX		(2 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH2_UART4TX		(3 | DMA_HS_DST | DMA_DIR_RX)

#define DMA_CH3_UART3TX		(0 | DMA_HS_DST | DMA_DIR_RX)
#define DMA_CH3_SPI1TX		(1 | DMA_HS_DST | DMA_DIR_RX)
