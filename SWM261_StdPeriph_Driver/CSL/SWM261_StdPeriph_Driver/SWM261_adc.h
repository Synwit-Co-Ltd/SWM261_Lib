#ifndef __SWM261_ADC_H__
#define	__SWM261_ADC_H__
...
typedef struct {
	uint16_t channels;		//ADC序列转换通道选中，ADC_CH0、ADC_CH1、... ... 、ADC_CH15及其组合（即“按位或”运算）
